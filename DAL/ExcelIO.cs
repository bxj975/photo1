...
namespace DAL
{
    public class ExcelIO
    {
        ...
        //数据库更新
        public void InsertData(DataTable ds)
        {
            ...
            try
            {
                ...
                {
                    string sql = "INSERT INTO U_Custom(U_Name,U_RelName,U_Telephone,U_MoveTele,U_Email,U_QQ,U_WeiXin,U_Address,U_LoginTime)"
                                + " VALUES('" + datarow["客户名称"].ToString() + "','" + datarow["联系人"].ToString() + "','" + datarow["电话"].ToString() + "'"
                                + ",'" + datarow["手机"].ToString() + "','" + datarow["邮箱"].ToString() + "','" + datarow["QQ"].ToString() + "','" + datarow["微信"].ToString() + "'"
                                + ",'" + datarow["地址"].ToString() + "', getdate())";

                    using (SqlConnection sqlconn = new SqlConnection(DBHelp.strConn))
                    {
                        sqlconn.Open();
