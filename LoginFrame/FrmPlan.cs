...
namespace LoginFrame
{
    ...
    {
        public FrmPlan(string state,string yearmonth,string barcode)
        {
            InitializeComponent();
            this.state = state;
            this.yearmonth = yearmonth;
        }
        int A, B, C, D, E, F, G, H, I, J,Mon,Type;
        public String state,yearmonth,barcode;
        private void Btn_Update_Click(object sender, EventArgs e)
        {
            BindData();
            string SqlStr = "update U_AllPlan set U_A=" + A + ",U_B='" + B + "',U_C=" + C + ",U_D=" + D + ",U_E=" + E + ", U_F=" + F + ",, U_G=" + G + ", U_H=" + H + ", U_I=" + I + ", U_J=" + J + "  where U_Id=" + barcode ;
        ...
        private void Btn_Add_Click(object sender, EventArgs e)
        {
            ...
            string SqlStr = "insert into U_AllPlan(U_A,U_B,U_C,U_D,U_E,U_F,U_G,U_H,U_I,U_J,U_Type,U_Month,U_LoginTime)  values(" + A + ",'" + B + "'," + C + "," + D + "," + E + "," + F + "," + G + "," + H + "," + I + "," + J + "," + Type + "," + Mon + ",getdate())"; 
            if (DAL.DBHelp.ExecuteNonQuery(SqlStr) > 0)
        ...
        {            
            ...
            if (state == "update")
            {
                string str = "select * from U_AllPlan where U_Id=" + barcode;
