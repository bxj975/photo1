...
namespace LoginFrame
{
    public class PrintDataGridView
    {
        ...
        private static int printRowCount = 0;//行合计

        private static bool IsPrint = true;//是否打印
        private static bool IsRole = true;
        private static int PoXTmp = 0;
        private static int PoYTmp = 0;
        private static int WidthTmp = 0;//宽
        private static int HeightTmp = 0;//高
        private static int RowIndex = 0;//行索引
