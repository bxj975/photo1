...
{
    public partial class FrmDepPlan : Form
    {
        public FrmDepPlan(string state, string yearmonth, string barcode)
        {
            InitializeComponent();
            this.state = state;
        ...
        {
            BindData();
            string SqlStr = "update U_DepPlan set U_A=" + A + ",U_B='" + B + "',U_C=" + C + ",U_D=" + D + ",U_E=" + E + ", U_F=" + F + ",, U_G=" + G + ", U_H=" + H + ", U_I=" + I + ", U_J=" + J + "  where U_Id=" + barcode;
        ...
        private void Btn_Add_Click(object sender, EventArgs e)
        {
            ...
            string SqlStr = "insert into U_DepPlan(U_A,U_B,U_C,U_D,U_E,U_F,U_G,U_H,U_I,U_J,U_Type,U_Month,U_ClerkType,U_LoginTime)  values(" + A + ",'" + B + "'," + C + "," + D + "," + E + "," + F + "," + G + "," + H + "," + I + "," + J + "," + Type + "," + Mon + "," + ClerkType + ",getdate())";
            if (DAL.DBHelp.ExecuteNonQuery(SqlStr) > 0)
        ...
        private void FrmDepPlan_Load(object sender, EventArgs e)
        {
            ...
            if (state == "update")
            {
                string str = "select * from U_DepPlan where U_Id=" + barcode;
