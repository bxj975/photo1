...
namespace LoginFrame
{
    public partial class Landing : Form
    {
        public Landing()
        {
            ...
            string title = System.Configuration.ConfigurationManager.AppSettings["title"].ToString();//窗口标题
            this.Text = title;
            this.skinEngine1.SkinFile = "../../Skins/" + System.Configuration.ConfigurationManager.AppSettings["image"].ToString();
            this.skinEngine1.SkinAllForm = true;
        }
        public static string checkCode = "";//随机码
        /// <summary>
        /// 产生验证码随机数
        /// </summary>
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.Opacity = 0;
            timer1.Start();
            string ButtonShow =System.Configuration.ConfigurationManager.AppSettings["ButtonShow"].ToString();//是否显示登录界面密码找回按钮(0:隐藏 1:显示)
            if (ButtonShow == "0")
            {
        ...
        {
            System.Diagnostics.Process.Start("http://www.xkaifa.com");
        }
